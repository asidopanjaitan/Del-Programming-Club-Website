...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2020 at 07:40 AM
...
(5, 'kamu ganteng deh', 'Mukdin', ''),
(6, 'Kamu lucu dehhh', 'Fordin', ''),
(7, 'Bagaimana Caranya', 'Mukdin', ''),
(8, 'makasih modulnyaa', 'Mukdin', ''),
(9, 'Bagaimana caranya', 'Mukdin', '');
...
(5, 'Dev C++', 'https://gsf-sp.softonic.com/599/853/e3331311f9ef81b1e633d7713dd258f81d/Dev-Cpp_5.11_TDM-GCC_4.9.2_Setup.exe?expires=1591849030&signature=80543cd01b9dca1f6db340ac9fbbc07f&url=https%3A%2F%2Fbloodshed-dev-c.en.softonic.com&filename=Dev-Cpp_5.11_TDM-GCC_4.9.2_Setup.exe');
...
--
ALTER TABLE `perlombaan`
  MODIFY `id_perlombaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
